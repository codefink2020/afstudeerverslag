...
in detail geeft dit de volgende methode: De Up-To-deploy reeks in het figuur wordt paralel gedraait voor iedere module in een project dus Backend,
...
\subsection{Voor en nadelen van de twee methoden}
