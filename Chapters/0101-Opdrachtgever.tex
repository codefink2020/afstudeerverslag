...
Eaglescience BV bestaat uit drie divisies: Innovations, Software en Solutions (figuur~\ref{fig:Eaglescience organogram}).%besxchrijving van de drie takken
...
\end{figure}
%TODO: vragen Wat zijn de hoofddoelen van iedere divisie?
%TODO: betere verwoording vragen:
...
\subsection{Missie}\label{sec:missie}
\marginpar{Missie}
...
\subsection{Visie}\label{sec:visie}
...
\subsection{Strategie}\label{sec:strategie}
