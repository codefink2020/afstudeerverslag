...
\end{figure}
De divisie Eaglecience Innovations zoekt naar nieuwe oplossingen op het gebied van softwareontwikkeling, welke door de divisie EagleScience software geïmplementeerd. EagleScience Solutions onderzoekt en adviseert over oplossingen voor gestelde problemen.\\
...
Daarnaast heeft Eaglescience over de afgelopen jaren een portfolio aan klantproducten opgebouwd met verchillende prodcuten. Deze producten worden gehost, onderhouden en er wordt service en support geboden richting gebruikers. Eaglescience is momenteel doende dit onder de noemer Software Lifecycle Management te integreren in het kwaliteitssysteem door middel van beleid en het vastleggen in werkprocessen. Het in de grip en up to date houden van de live softwareproducten vraagt om een gerichte-, transparante- en traceerbare aanpak ten aanzien van alle gebruikte software-onderdelen (bilbliotheken/ libraries) en onderliggende afhankelijkheden (dependencies).
