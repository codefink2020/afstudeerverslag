...
\ctparttext{In dit deel zijn er een aantal kleine aanpassingen gedaan..\\ Voor de rest moet hier nog een inleiding komen over het deel en de tot standkoming van de opdracht}

\part{Opdracht}\label{prt:opdracht}
\include{Chapters/0101-Opdrachtgever}
\include{Chapters/0102-Opdracht}
\include{Chapters/0103-PlanVanAanpak}
\ctparttext{Ben hier nog mee bezig Req analyse en onderzoeksmethode is soort van af en staat in wat ik wil }
